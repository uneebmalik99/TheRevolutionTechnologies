    ...
    return(
       ...
       <nav className='nav'>
        ...
        <ul className={active}>
            ...
            <li className="nav_item text-primary"><NavLink to="/team" className="nav-link">Our teams</NavLink></li>
            <li className="nav_item text-primary"><NavLink to="/services" className="nav-link">Services</NavLink></li>
            <li className="nav_item text-black-500"><NavLink to="/careers" className="nav-link">Careers</NavLink></li>

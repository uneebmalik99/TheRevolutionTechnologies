    ...
    return (
        <>
            ...
            <div className="container-fluid" id="contact-maincontainer">
                ...
                <div className="container" id="contact-container2" style={{ borderRadius: '40px' }}>
                        ...
                        <div className="col-sm-12 col-md-6 col-lg-6">
                            ...
                            <p className="contact-color-black contact-align contact-mar3">
                                <h5 className="contact-color-black contact-align contact-mar-b  ">
                                    ...
                                    Our Address</h5><span className="contact-span "><p class="contact-text">Office no 12, Aries Tower Maryam Business Center, Murree Rd, Shamsabad, Rawalpindi</p></span>
                            </p>

                            <p className="contact-color-black contact-align contact-mar3"><h5 className="contact-color-black contact-align contact-mar-b"> <EmailIcon fontSize="large" style={{ color: "#ffcc39" }} className="m-icon" /> Our Mails</h5> <span className="contact-span2"> <p class="contact-text">info@therevolutiontechnologies.com</p></span></p>
                            <p className="contact-color-black contact-align contact-mar3"><h5 className="contact-color-black contact-align contact-mar-b"> <EmailIcon fontSize="large" style={{ color: "#ffcc39" }} className="m-icon" /> Contact</h5> <span className="contact-span2"> <p class="contact-text">+92-331-7766-777</p></span></p>
                                ...
                                {isSubmitted ? (
                                    ...
                                    <form onSubmit={handleSubmit}>
                                        ...
                                        <textarea
                                            ...
                                            required
                                        ></textarea>
                                        <button style={{ color: 'navy', backgroundColor: '#BA8D06', fontWeight: 'bold', paddingInline: '2%' }} className="btn1" type="submit" id="sendButton">
                                            Send Email
                                        </button>

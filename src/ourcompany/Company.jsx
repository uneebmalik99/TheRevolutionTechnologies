    ...
    <>
      ...
      <div className="container-fluid contibm">
        <div className="row  ">
          <div className=" col-xs-12 col-sm-12 col-md-2 col-lg-3 comp-ibm ">
            <img src="images/ibm.png" alt="pic" />
          </div>
          <div className=" col-xs-12 col-sm-12 col-md-2 col-lg-2 comp-ibm">
            <img src="images/ibm2.png" alt="pic" />
          </div>
          <div className=" col-xs-12 col-sm-12 col-md-2 col-lg-2 comp-ibm">
            <img src="images/ibm3.png" alt="pic" />
          </div>
          <div className=" col-xs-12 col-sm-12 col-md-2 col-lg-2 comp-ibm">
            <img src="images/ibm4.png" alt="pic" />
          </div>
          <div className=" col-xs-12 col-sm-12 col-md-2 col-lg-3 comp-ibm">
            <img src="images/ibm5.png" alt="pic" />
          </div>
        </div>
      </div>
      ...
      <div className="row cardsdata ">
        ...
        {cardData.map((card, index) => (
          <Card className = "" key={index} heading={card.heading} text={card.text} />
        ))}
      </div>
    </div>
